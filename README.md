...
A Python program to model different seasons on a landscape, and to compute and plot the Optimal Path for the sport of [**Orienteering**](en.wikipedia.org/wiki/Orienteering) in 3D space. 
